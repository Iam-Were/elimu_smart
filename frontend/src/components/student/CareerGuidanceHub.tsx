...
const careerSpotlights: CareerSpotlight[] = [
  {
    ...
    fullDescription:
      'Software engineers are the architects of the digital world. They create applications, websites, mobile apps, and complex systems that power modern businesses and daily life. This field combines creativity with technical skills to solve real-world problems through code.',
    dayInLife: [
    ...
    careerPath: [
      {
        step: 'Junior Developer',
        timeframe: '0-2 years',
        description:
          'Learn fundamentals, work on small features, gain experience',
      },
      {
        step: 'Mid-level Developer',
        timeframe: '2-5 years',
        description:
          'Lead projects, mentor juniors, specialize in technologies',
      },
      {
        step: 'Senior Developer',
        timeframe: '5-8 years',
        description:
          'Architecture decisions, technical leadership, complex projects',
      },
      {
        step: 'Tech Lead/Architect',
        timeframe: '8+ years',
        description:
          'Team leadership, system design, strategic technical decisions',
      },
    ],
    salary: {
      entry: 80000,
    ...
    successStory: {
      ...
      story:
        'Started as a self-taught programmer while studying at University of Nairobi. Built mobile apps as side projects, landed internship at a startup, and worked her way up to leading the mobile payments team at M-Pesa. Now earning KSh 400K monthly and mentoring other women in tech.',
    },
    resources: [
  ...
  },
  {
    ...
    image: '/api/placeholder/400/300',
    shortDescription:
      'Diagnose, treat, and prevent illnesses to improve human health.',
    fullDescription:
      'Doctors are healthcare professionals who diagnose and treat illnesses, injuries, and health conditions. They work directly with patients to understand symptoms, run tests, prescribe medications, and develop treatment plans. This profession requires extensive medical knowledge, strong communication skills, and genuine care for human welfare.',
    dayInLife: [
    ...
    requirements: {
      education: [
        ...
        'Specialization training (3-5 years)',
      ],
      skills: [
        'Diagnostic skills',
        'Communication',
    ...
    careerPath: [
      {
        step: 'Medical Student',
        timeframe: '6 years',
        description:
          'Study medicine, clinical rotations, medical knowledge foundation',
      },
      {
        step: 'Medical Intern',
        timeframe: '1 year',
        description:
          'Supervised practice in hospital, gain practical experience',
      },
      {
        step: 'Medical Officer',
        timeframe: '2-3 years',
        description: 'Independent practice, general medicine, patient care',
      },
      {
        step: 'Specialist',
        timeframe: '3-5 years training',
        description:
          'Specialized training in chosen field (cardiology, surgery, etc.)',
      },
    ],
    salary: {
      entry: 120000,
    ...
    successStory: {
      ...
      story:
        'Grew up in rural Kenya, excelled in sciences at Moi High School. Studied medicine at University of Nairobi, specialized in cardiovascular surgery in South Africa. Now performs life-saving heart surgeries and has trained over 50 young doctors. Earns KSh 1.2M monthly and runs a free clinic in his hometown.',
    },
    resources: [
  ...
  },
  {
    ...
    image: '/api/placeholder/400/300',
    shortDescription:
      'Educate and inspire students to reach their full potential.',
    fullDescription:
      'Teachers are the foundation of society, shaping young minds and preparing the next generation for success. They create lesson plans, deliver instruction, assess student progress, and provide guidance. Beyond academics, teachers mentor students, help develop character, and inspire lifelong learning.',
    dayInLife: [
    ...
    careerPath: [
      {
        ...
        timeframe: '1 year',
        description: 'Teaching practice, gain classroom experience',
      },
      {
        step: 'Graduate Teacher',
        timeframe: '0-3 years',
        description: 'Entry-level teaching, learn school systems',
      },
      {
        step: 'Senior Teacher',
        timeframe: '3-8 years',
        description: 'Department responsibilities, mentor new teachers',
      },
      {
        step: 'Head Teacher/Principal',
        timeframe: '8+ years',
        description: 'School leadership, administration, strategic planning',
      },
    ],
    salary: {
      entry: 35000,
    ...
    successStory: {
      ...
      story:
        "Started as a mathematics teacher in rural school after Kenyatta University. Through dedication and continuous learning, became head of department, deputy principal, and now leads one of Kenya's top schools. Her students consistently excel in KCSE, and she's transformed the school into a model institution.",
    },
    resources: [
      ...
      {
        title: 'Kenya Institute of Curriculum Development',
        type: 'website',
        url: '#',
      },
    ],
...
export const CareerGuidanceHub: React.FC = () => {
  ...
  const [selectedCareer, setSelectedCareer] = useState<CareerSpotlight | null>(
    null
  );
      ...
      <Stack gap="lg">
        ...
        <Stack gap="sm">
          ...
          <Text size="lg" c="dimmed">
            Explore detailed career information, success stories, and pathway
            guidance
          </Text>
        </Stack>
        ...
        <Card shadow="sm" padding="lg" radius="md">
          <Group gap="md" align="flex-end">
            ...
            <Button
              variant="light"
              color="blue"
              leftSection={<BookmarkIcon width={16} height={16} />}
            >
              ...
              <Stack gap="md">
                ...
                <Group gap="sm">
                  <Badge color="green" variant="light" size="xs">
                    {formatSalary(career.salary.entry)} -{' '}
                    {formatSalary(career.salary.senior)}
                  </Badge>
                  <Badge
                    color={getDemandColor(career.jobOutlook.demand)}
                    variant="light"
                    size="xs"
                    leftSection={<StarIcon width={12} height={12} />}
                  >
                  ...
                  <Badge
                    ...
                    variant="light"
                    size="xs"
                    leftSection={<BarChartIcon width={12} height={12} />}
                  >
                ...
                <Stack gap="md">
                  ...
                  <SimpleGrid cols={{ base: 1, md: 2 }} spacing="md">
                    <Stack gap="sm">
                      ...
                      {selectedCareer.requirements.education.map(
                        (req, index) => (
                          <Badge
                            key={index}
                            variant="light"
                    ...
                    <Stack gap="sm">
                      ...
                      {selectedCareer.requirements.skills.map(
                        (skill, index) => (
                          <Badge
                            key={index}
                            variant="light"
              ...
              <Tabs.Panel value="story" pt="md">
                <Stack gap="md">
                  <Card shadow="xs" padding="lg" radius="md">
                    <Stack gap="md">
                      <Group gap="md">
                        ...
                        <Stack gap={2}>
                          <Text fw={500}>
                            {selectedCareer.successStory.name}
                          </Text>
                          <Text size="sm" c="dimmed">
                            {selectedCareer.successStory.position} at{' '}
                            {selectedCareer.successStory.company}
                          </Text>
                        </Stack>
                      </Group>
                  ...
                  <Alert color="green" variant="light">
                    ...
                    <Text size="sm">
                      Success in this field comes from dedication, continuous
                      learning, and practical experience. Start building
                      relevant skills early and look for mentorship
                      opportunities.
                    </Text>
                  </Alert>
                </Stack>
